<!--
  This file is vendored from google-labs-code/design.md.
  Source:  https://github.com/google-labs-code/design.md/blob/main/docs/spec.md
  License: Apache-2.0 (see https://github.com/google-labs-code/design.md/blob/main/LICENSE)
  Spec version: alpha

  The skill bundles this copy so it works offline. To re-sync the latest spec:
    gh api repos/google-labs-code/design.md/contents/docs/spec.md \
      --jq '.content' | base64 -d > reference/spec.md
-->
